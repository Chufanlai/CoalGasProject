...
function createData(){
	...
	o.selectByID = function(_ID) {
		return myData.ObjData[_ID];
	}
	return o;
}
...
function createVis1(times){
	var o={};
	times.forEach(function(ele, i) {
		times[i] = timeFormat.parse(times[i]);
	});
	o.times=times;
	o.startTime = o.nowTime = d3.min(o.times);
	o.endTime = d3.max(o.times);

	o.col=d3.interpolate("#0F0","#F00");
	o.maxDrawingWithoutZoom = 5;
	o.draw=drawTimeline;
	o.appendL = appendTimeline;
	o.removeL = removeTimeline;
	o.nowDrawing = [];
	o.update = updateVis;
	o.moveTimeTag = moveTimeTag;
	o.maxDrawing = 10;
	o.shiftDrawing = 0;
	o.ratioLimit=0.8;
	o.padding = 5;
