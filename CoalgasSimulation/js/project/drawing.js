 ...
 */
 function appendTimeline(_ID) {
	...
	//data processing for line drawing
	var _data = myData.selectByID(_ID);
	//console.log(_data);
	var _areaData = [];
	for (var i = 0; i < myData.attrs.length; i++) {
...
/**
 * remove timeline with id "Chart_ID"
 * @param  {string} _ID
 * @return {none}
 */
 ...
 */
 function showNextT() {
 	...
 	if (nextTime == undefined) {
		...
		Vis.nowTime = nextTime;
		showAllAtT(nextTime, 2000/playSpeed);
